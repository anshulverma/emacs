...
;; base of jmax library code
(defvar av-jmax-dir (expand-file-name "jmax" av-lib-dir)
  "Customizations copied from https://github.com/jkitchin/jmax.")
...
(setq org-id-locations-file
      (expand-file-name ".org-id-locations" av-basedir))
(require 'org-id)
...
;;	 (expand-file-name "org" av-basedir)))
...
(add-to-list 'load-path
	     (expand-file-name "org" av-jmax-dir))
...
;;* cm-mode
(add-to-list 'load-path
	     (expand-file-name "criticmarkup-emacs" av-jmax-dir))
...
(add-to-list 'load-path
	     (expand-file-name "org-ref" av-jmax-dir))
...
(cond
 ((string= system-type "windows-nt")
  (setq-default ispell-program-name
		(expand-file-name
		 "Aspell-win32/bin/aspell.exe" av-basedir))
  (flyspell-mode +1)
